  ...
  methods: {
    ...
    getItems() {
      ...
      axiosPostApi('/init_precios',
          ...
          res => {
            this.items = res.data.precios.itemsRows;
            this.itemsNumber = res.data.precios.itemsNumber;
            this.pagesNumber = res.data.precios.pagesNumber;
            this.currentPage = res.data.precios.currentPage;
            this.setFooterPages();
