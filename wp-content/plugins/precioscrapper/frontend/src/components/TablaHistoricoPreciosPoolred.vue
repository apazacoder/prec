  ...
  <div>
    <div class="cs-tabla-wrapper">
      <table class="cs-tabla-precio">
        ...
        <tr>
          <th colspan="4">Histórico de precios: Poolred</th>
        </tr>
        <tr>
          <th>Fecha</th>
          <th>Virgen extra</th>
        ...
        <tr>
          <td colspan="4">
            ...
            Precios medios del aceite en España | Poolred.com - S/C: Sin cotización
          </td>
        </tr>
        </tfoot>
      </table>
...
<script>
export default {
  name: "TablaHistoricoPreciosPoolred",
  data() {
    return {
      tablaDatos: {
        extra_virgen: [],
  ...
  mounted() {
    axiosGetApi('/tabla/historico/precios/poolred', (res) => {
