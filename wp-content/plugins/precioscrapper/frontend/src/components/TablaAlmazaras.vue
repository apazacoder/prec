<template>
  <div>
    <table class="cs-tabla-precio" v-if="tablaDatos.precios.length > 0">
      ...
      <tr>
        <th v-text="tablaDatos.fecha_hasta"></th>
        <th>Precios €/Kg</th>
      </tr>
      </thead>
      <tbody>
      <tr>
        ...
        <td >
          <span v-text="(tablaDatos.precios[0].precio != '0.000' ? tablaDatos.precios[0].precio + '€' : 'S/C')"></span>
          <span v-if="tablaDatos.precios[0].precio != '0.000'" class="precio-metadata">
      ...
      <tr>
        ...
        <td>
          <span v-text="(tablaDatos.precios[1].precio != '0.000' ? tablaDatos.precios[1].precio + '€': 'S/C')"></span>
          <span v-if="tablaDatos.precios[1].precio != '0.000'" class="precio-metadata">
      ...
      <tr>
        ...
        <td>
          <span v-text="(tablaDatos.precios[2].precio != '0.000' ? tablaDatos.precios[2].precio + '€' : 'S/C')"></span>
          <span v-if="tablaDatos.precios[2].precio != '0.000'" class="precio-metadata">
      ...
      <tr>
        <td>
          ...
          Precio del aceite en Córdoba | Almazarasfederadas.es
        </td>
        <td>
          S/C: Sin cotización
        </td>
...
export default {
  ...
  mounted() {
    axiosGetApi('/tabla/almazaras', (res) => {
